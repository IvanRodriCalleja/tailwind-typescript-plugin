...
<template>
  <div class="flex flex-col">
  			<div :class="clsx('flex', isActive ? 'invalid-active' : 'bg-gray-500')">
  				Invalid in first child
  			</div>
  			<div :class="clsx('flex', isActive ? 'bg-blue-500' : 'bg-gray-500')">
  				Valid in second child
  			</div>
  			<div :class="clsx('flex', isActive ? 'invalid-class' : 'bg-gray-500')">
