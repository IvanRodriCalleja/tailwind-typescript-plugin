...
describe('[Vue] test-variable-in-array', () => {
	describe('error-01-invalid-variable-in-array', () => {
		it('should detect invalid class in variable used in array and report at script position', async () => {
			...
			try {
				...
				// The diagnostic points directly to 'invalid-array-var' in the script (line 2)
